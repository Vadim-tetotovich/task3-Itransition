(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material'), require('@angular/common'), require('ngx-spanish-pipe')) :
    typeof define === 'function' && define.amd ? define('ngx-table-generator', ['exports', '@angular/core', '@angular/material', '@angular/common', 'ngx-spanish-pipe'], factory) :
    (global = global || self, factory(global['ngx-table-generator'] = {}, global.ng.core, global.ng.material, global.ng.common, global.ngxSpanishPipe));
}(this, (function (exports, core, material, common, ngxSpanishPipe) { 'use strict';
    ...
    var TableGeneratorService = /** @class */ (function () {
        ...
        /** @nocollapse */ TableGeneratorService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function TableGeneratorService_Factory() { return new TableGeneratorService(); }, token: TableGeneratorService, providedIn: "root" });
    ...
    var TableUtils = /** @class */ (function () {
        ...
        /** @nocollapse */ TableUtils.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function TableUtils_Factory() { return new TableUtils(); }, token: TableUtils, providedIn: "root" });
        return TableUtils;
    }());
    ...
    var TableGeneratorComponent = /** @class */ (function () {
        function TableGeneratorComponent(tableUtils, datePipe) {
            ...
            this.onPageEvent = new core.EventEmitter();
            this.buttonEvent = new core.EventEmitter();
            this.rowClick = new core.EventEmitter();
            this.sortChange = new core.EventEmitter();
            this.suboperationAction = new core.EventEmitter();
            this.trashAction = new core.EventEmitter();
            this.multiCheckAction = new core.EventEmitter();
        ...
        Object.defineProperty(TableGeneratorComponent.prototype, "sortOptions", {
             ...
             */
            function (value) {
                this.sort = new material.MatSort();
                this.sortOptionData = {
        ...
        TableGeneratorComponent.propDecorators = {
            onPageEvent: [{ type: core.Output }],
            buttonEvent: [{ type: core.Output }],
            rowClick: [{ type: core.Output }],
            sortChange: [{ type: core.Output }],
            suboperationAction: [{ type: core.Output }],
            trashAction: [{ type: core.Output }],
            multiCheckAction: [{ type: core.Output }],
            disabledMulticheck: [{ type: core.Input }],
            footerData: [{ type: core.Input }],
            sort: [{ type: core.ViewChild, args: [material.MatSort, { static: false },] }],
            paginator: [{ type: core.ViewChild, args: [material.MatPaginator, { static: false },] }],
            classMap: [{ type: core.Input, args: ['classMap',] }],
            dataSourceMap: [{ type: core.Input, args: ['dataSource',] }],
            columns: [{ type: core.Input, args: ['dataColumnsTable',] }],
            sortOptions: [{ type: core.Input, args: ['sortOptions',] }],
            paginatorOption: [{ type: core.Input, args: ['paginatorOption',] }],
            buttonOptions: [{ type: core.Input, args: ['buttonOptions',] }]
        };
        ...
        TableGeneratorModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            ngxSpanishPipe.NgxSpanishPipeModule
                        ],
                        exports: [
                            TableGeneratorComponent
                        ],
    ...
    exports.TableGeneratorComponent = TableGeneratorComponent;
    exports.TableGeneratorModule = TableGeneratorModule;
    exports.TableGeneratorService = TableGeneratorService;
    exports.ɵa = TableUtils;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-table-generator.umd.js.map
